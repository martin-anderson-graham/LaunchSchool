...
function sentiment(text) {
  ...
  let positive = wordList.filter( word => word.match(positiveRegex));
  let negative = wordList.filter( word => word.match(negativeRegex));

  result += `There are ${positive.length} type words in the text.\n`;
  result += `Positive sentiments: ${positive.join(', ')}\n\n`;

  result += `There are ${negative.length} type words in the text.\n`;
  result += `Negative sentiments: ${negative.join(', ')}\n\n`;
